...
"true"===a.getAttribute("aria-disabled"));)a=a.nextElementSibling;a&&(a.classList.add(f.prefix+"-active"),g.dispatchEvent("enter",a.id),e=a)}}function H(a){a.classList.remove(f.prefix+"-active");a=a.querySelectorAll("."+f.prefix+"-active");for(var b=0;b<a.length;b++)a[b].classList.remove(f.prefix+"-active")}function E(a){var b=document.createElement("li");b.className=f.prefix+"-placeholder";b.textContent=a||f.defaultPlaceholder;b.setAttribute("aria-disabled","true");return b}function A(a){for(var b=
1;a.parentNode&&a.parentNode!==d;)a=a.parentNode,++b;return b}function k(a){a=a||null;var b,c=document.querySelectorAll("."+f.prefix+"-focus");for(b=0;b<c.length;b++){var h=c[b];if(!a||a!==h){var d=h.querySelectorAll("."+f.prefix+"-active");for(b=0;b<d.length;b++)d[b].classList.remove(f.prefix+"-active");d=h.querySelectorAll("."+f.prefix+"-open-1");for(b=0;b<d.length;b++)d[b].classList.remove(f.prefix+"-open-1");h.classList.remove(f.prefix+"-focus")}}e&&a!==e&&g.dispatchEvent("leave",e.id);e=a}function J(a){var b,
...
if(a=/^f(\d+)$/.exec(a))return 111+Number(a[1])}function I(a){for(var b=1;a!==d;)"UL"===a.nodeName&&++b,a=a.parentNode;return b}function B(a){"true"===a.getAttribute("aria-checked")?a.removeAttribute("aria-checked"):a.setAttribute("aria-checked","true")}function z(a){for(var b=a.parentNode.querySelectorAll('li[name="'+a.getAttribute("name")+'"][aria-checked="true"]'),c=0;c<b.length;c++)b[c].removeAttribute("aria-checked");a.setAttribute("aria-checked","true")}var g=this,t=null,u,d,m={},L,e,v=!1,G=
!1,M=!1,q,C,f={prefix:"menu",popupDelay:300,menuActiveDuration:120,hotkey:null,skipDisabledItems:!0,defaultPlaceholder:"No items"};document.documentElement.classList.add(platform.os.family.toLowerCase().replace(/\W+/g,"-"));var P=["icon","align","placeholder","shortcut"],r={show:!1,separator:"",order:"scam",keys:{s:"",c:"",a:"",m:""}};switch(platform.os.family.toLowerCase()){case "windows":case "windows xp":case "windows nt":case "windows server 2008 r2 / 7":case "windows server 2008 r2 / 7 x64":case "windows server 2008 / vista":r=
...
0;e<m[c.type].length;e++)m[c.type][e].call(this,c)};g.get=function(a){var b=document.getElementById(a);if(!b)return{};a={align:b.getAttribute("data-align")||"left",className:b.className,disabled:"true"===b.getAttribute("aria-disabled")||!1,icon:b.getAttribute("data-icon")||null,id:a,menu:t,placeholder:b.getAttribute("data-placeholder")||f.defaultPlaceholder,shortcut:b.getAttribute("data-shortcut")||null,role:b.getAttribute("role")||null};if("menuitemcheckbox"===a.role||"menuitemradio"===a.role)a.checked=
"true"===b.getAttribute("aria-checked")||!1;"menuitemradio"===a.role&&(a.name=b.getAttribute("name")||null);return a};g.getGroupChecked=function(a){return(a=d.querySelector('li[name="'+a+'"][aria-checked="true"]'))?a.id:null};g.insertAfter=function(a,b){var c,e;a?c=document.getElementById(a):d.children.length?c=d.children[d.children.length-1]:(e=document.createElement("li"),d.appendChild(e),c=e);c&&(x(c,b),e&&d.removeChild(e))};g.insertBefore=function(a,b){var c,e;a?c=document.getElementById(a):d.children.length?
