...
g?z(e):"menuitemradio"===g&&w(e),h.dispatchEvent("select",e.id),k()):p(e,F(e),!0));break;case 37:if(2<F(e))e.parentNode.className="",E(e),e=e.parentNode.parentNode;else{a=I();c=n;l=a.indexOf(n);do m?++l>=a.length&&(l=0,++g):0>--l&&(l=a.length-1,++g),c=a[l];while("true"===c.getAttribute("aria-disabled")&&3>g);n!==c&&(E(n),c.classList.add(f.prefix+"-active"),h.dispatchEvent("enter",c.id),p(c,1),e=c)}break;case 39:if(e.parentNode!==d&&e.children.length)p(e,F(e),!0);else{a=I();c=n;l=a.indexOf(n);do m?
