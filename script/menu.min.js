...
"-active"),g.dispatchEvent("enter",c.id),p(c,1),e=c)}break;case 39:if(e.parentNode!==d&&e.children.length)g.dispatchEvent("leave",e.id),p(e,I(e),!0);else{a=K();c=n;l=a.indexOf(n);do m?0>--l&&(l=a.length-1,++h):++l>=a.length&&(l=0,++h),c=a[l];while(f.skipDisabledItems&&"true"===c.getAttribute("aria-disabled")&&3>h);n!==c&&(H(n),c.classList.add(f.prefix+"-active"),g.dispatchEvent("enter",c.id),p(c,1),e=c)}break;case 38:c=e.parentNode===d&&n.children.length?n.children[0].children[n.children[0].children.length-
1]:e.previousElementSibling;b(!0);break;case 40:e.parentNode===d&&n.children.length?(e.children.length&&!e.children[0].classList.contains(f.prefix+"-open-1")&&p(e,1),c=n.children[0].children[0]):c=e.nextElementSibling;b();break;case 33:if(h=e.parentNode===d?e.children[0]:e.parentNode)c=h.children[0],b();break;case 34:if(h=e.parentNode===d?e.children[0]:e.parentNode)c=h.children[h.children.length-1],b(!0)}}}function K(){for(var a=[],b=0,c=d.children.length;b<c;b++)a.push(d.children[b]);a.sort(function(a,
b){return a.offsetLeft-b.offsetLeft});return a}function Q(a){if(!a)return 0;if(1==a.length)return a.toUpperCase().charCodeAt(0);if(a=/^f(\d+)$/.exec(a))return 111+Number(a[1])}function I(a){for(var b=1;a!==d;)"UL"===a.nodeName&&++b,a=a.parentNode;return b}function B(a){"true"===a.getAttribute("aria-checked")?a.removeAttribute("aria-checked"):a.setAttribute("aria-checked","true")}function z(a){for(var b=a.parentNode.querySelectorAll('li[name="'+a.getAttribute("name")+'"][aria-checked="true"]'),c=0;c<
b.length;c++)b[c].removeAttribute("aria-checked");a.setAttribute("aria-checked","true")}var g=this,t=null,u,d,m={},L,e,v=!1,G=!1,M=!1,q,C,f={prefix:"menu",popupDelay:300,menuActiveDuration:120,hotkey:null,skipDisabledItems:!0,defaultPlaceholder:"No items"};document.documentElement.classList.add(platform.os.family.toLowerCase().replace(/\W+/g,"-"));var P=["icon","align","placeholder","shortcut"],r={show:!1,separator:"",order:"scam",keys:{s:"",c:"",a:"",m:""}};switch(platform.os.family.toLowerCase()){case "windows":case "windows xp":case "windows nt":case "windows server 2008 r2 / 7":case "windows server 2008 r2 / 7 x64":case "windows server 2008 / vista":r=
